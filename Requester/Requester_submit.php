...
?>
           ...
           <div class="col-sm-10 col-md-10 mt-5">
             <div class="form-row">
                ...
                <h2 align='center'>NEW BOOKING</h2>
                </div>
             </div>
             <div class="form-row">
                <div class="form-group col-md-10 mx-5">
             ...
             <div class="form-row">
               ...
               <div class="form-group col-sm-1"></div>
                ...
                <div class="form-group col-md-5 ">
                <label for="inputEmail">Property Type<span>*<span></label>
                <select id="box4" class="form-control "type=text name='rProperty'required>
               ...
               <div class="form-group col-sm-5">
                ...
                <label for="inputName">Email<span>*<span></label>
                 <input type="email"  name="rEmail"class="form-control"placeholder="Email">
                  ...
                  <!-- 5th coloumn -->
                  <div class="form-group col-md-5 ">
                <label for="inputEmail">Identity Proof<span>*<span></label>
                ...
                <div class="form-group col-md-5 ">
                 ...
                 <input style="margin-top:30px;" type="file"  name="rfile"class="form-control"required>
                </div>
